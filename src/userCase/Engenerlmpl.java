...
public class Engenerlmpl implements EngineerInterface {
	...
	try {
		PreparedStatement preparedStatement=connection.prepareStatement("select * from enginer INNER JOIN complain INNER JOIN eng_complain ON enginer.enId=eng_complain.enId and"
				+ " complain.cid=eng_complain.cid where enginer.enId=? "
				+ "and complain.c_status='pending' group by complain.cid");
